...
CREATE TABLE silver.crm_cust_info(
	...
	dwh_insert_date DATETIME2 DEFAULT GETDATE()  -- EXTRA COLUMN TO GET THE DATE AND TIME THAT DATA WILL BE INSERTED 
); 
...
CREATE TABLE silver.crm_prd_info(
	prd_id	INT ,	
	prd_key	NVARCHAR(50),
	cat_id NVARCHAR(50), -- added in transformation step
	prd_nm	NVARCHAR(50),
	prd_cost INT ,
	prd_line NVARCHAR(50),
	prd_start_dt	DATE , -- changed from DATETIME
	prd_end_dt DATE , -- changed from DATETIME
	dwh_insert_date DATETIME2 DEFAULT GETDATE() -- EXTRA COLUMN TO GET THE DATE AND TIME THAT DATA WILL BE INSERTED
)
...
CREATE TABLE silver.crm_sales_details(
	...
	sls_cust_id	INT ,
	sls_order_dt	DATE , -- updated data type from INT to DATE
	sls_ship_dt	DATE ,
	sls_due_dt	DATE,
	sls_sales	INT ,
	sls_quantity	INT ,
